...
<html>
  <head>
    ...
    <title>Internal Transfer - Banking System</title>
	...
	<script type="text/javascript">
		...
		function transfercheck(){
			...
			document.getElementById("internaltransferform").submit();
		}
  ...
  <body>
    ${username}, Your Balance: $${balance} <br>   
    <form id="internaltransferform" action="<%=path%>/internaltransfercommit"
			method="POST">
			<ul>
				<li>
					<label>
